        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('restaurant.tables.store') }}" autocomplete="off">
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('n_sits') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="n_sits" id="input-n_sits" class="form-control form-control-alternative{{ $errors->has('n_sits') ? ' is-invalid' : '' }}" placeholder="{{ __('n_sits') }}" value="{{ old('n_sits') }}" required>
